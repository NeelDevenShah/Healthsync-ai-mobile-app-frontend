...
const DoctorNotificationsScreen = () => {
    ...
    const handleNotificationPress = (notification) => {
        ...
        if (notification.data?.referenceType === 'appointment') {
            navigation.navigate('DoctorAppointmentDetail', { appointmentId: notification.data.referenceId });
        } else if (notification.data?.referenceType === 'diagnosis') {
            navigation.navigate('DoctorDiagnosisDetail', { diagnosisId: notification.data.referenceId });
        } else if (notification.data?.referenceType === 'report') {
            navigation.navigate('DoctorReportDetail', { reportId: notification.data.referenceId });
        }
        // Other notification types could be added here
    };
